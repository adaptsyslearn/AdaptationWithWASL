...
3. A [modified version](https://github.com/adaptsyslearn/TailBenchMod) of [TailBench](https://tailbench.csail.mit.edu/) provided with
   this repository and related tailBench inputs. This has been to correctly installed for the executables to work. 
...
4. **Update the location of the tailbench binaries in `apto-tailbench-apps/src/apps.rs` to reflect the correct file paths** (IMPORTANT).
